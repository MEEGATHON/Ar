...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@MEGGAX")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/MEEGATHON/Assistant")
    AUTONAME = os.environ.get("AUTONAME", "@MEGGAX")
