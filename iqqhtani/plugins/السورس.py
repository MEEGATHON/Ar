...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/1d792d855afb8ccb064dc.jpg"
...
async def iq(iqqhtanievent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 TO MEEGATHON 𓃠"
    Iqqhtani_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/1d792d855afb8ccb064dc.jpg"
...
async def amireallyalive(event):
    ...
    Iqqhtani_ALIVE_TEXT = "❬ ميكاثون العـرب - MEEGATHON-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس ميكاثون @MEGGAX :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث ميكاثون انتضر من 5 الى 10 دقائق")
    try:
...
async def variable(var):
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await ics.edit("**⌔ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت ميكاثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/MEGGAX/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط القروب يضيفهم بقروبك
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/MEGGAX/4483
شرح الأوامر : ( @MEGGAX ) .
قناه السورس : ( @MEGGAX ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/MEGGAX/4704
قناه السورس : ( @MEGGAX ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/MEGGAX/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/MEGGAX/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/MEGGAX/4720  ⦒
""")
...
———————×———————
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت ميكاثون لديك
———————×———————
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات ميكاثون
———————×———————
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته
———————×———————
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع الميكاثون
———————×———————
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء الميكاثون بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل الميكاثون
———————×———————
الأمر ⦙ ( .الاوامر )
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لميكاثون
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه ميكاثون بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
@check_owner
async def inlineiqqhtani(iqqhtani):
    text = " ℘︙ قـائمـه الاوامـر :**\n ℘︙ قنـاه السـورس :** @Iqqhtani\n ℘︙ شـرح اوامـر السـورس : @MEGGAX**\n ℘︙ شـرح فـارات السـورس : @MEGGAX** "
