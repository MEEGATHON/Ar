...
LOGS = logging.getLogger("ميكاثون\n ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين ميكاثون العام", iqqhtani, Config.TG_BOT_USERNAME, descript        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين ميكاثون الخاص ", iqqhtani, Config.TG_BOT_USERNAME, descript        )
